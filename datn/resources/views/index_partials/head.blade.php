<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/css_effect.css')}}">
    <link rel="stylesheet" href="{{asset('assets/css/css_effect1.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('assets/bootstrap-5.0.2-dist/..')}}">
    ...
    <script src="{{asset('assets/OwlCarousel2-2.3.4/docs/assets/vendors/jquery.min.js')}}"></script>
    ...
    <script src="{{asset('assets/js/jquery.pixelentity.shiner.min.js')}}"></script>
    <script src="{{asset('assets/js/jQuery.WCircleMenu-min.js')}}"></script>
