...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            @if($all->LaAdmin)
            <td>
                <input type="checkbox" id="LaAdmin" name="LaAdmin" value="yes" checked
                    onclick="return false;" />
            </td>
            @else
            <td>
            ...
            @endif
            <td>
              <a id="update_btn" href="{{route('edit_empl', ['id' => $all->MaNV])}}" class="mr-3 func_icon !important" title="Cập nhật"
                  data-toggle="tooltip"><span class="fa fa-pen"></span></a>
              <a id="del_btn" href="{{route('func_delete_empl', ['id' => $all->MaNV])}}" title="Xoá"
